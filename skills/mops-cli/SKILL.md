...
name: mops-cli
description: >-
  Manage Motoko projects with the mops CLI — toolchain pinning, dependency
  management, type-checking, building, and linting. Use when working with
...
<!--
Vendored from caffeinelabs/mops .agents/skills/mops-cli/SKILL.md.
Do not edit below this comment: scripts/sync-mops-cli-skill.mjs overwrites it
on every run. Send changes upstream instead.
-->
