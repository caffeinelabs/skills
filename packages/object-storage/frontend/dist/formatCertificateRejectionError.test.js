...
void describe("formatCertificateRejectionError", () => {
    void it("maps DESTINATION_INVALID missing update method to install guidance", () => {
        const error = formatCertificateRejectionError({
            ...
            rejectMessage: "Canister has no update method '_immutableObjectStorageCreateCertificate'.",
        });
        assert.equal(error.message, "method not found on backend canister; install the caffeineai-object-storage mops package");
    });
...
//# sourceMappingURL=formatCertificateRejectionError.test.js.map